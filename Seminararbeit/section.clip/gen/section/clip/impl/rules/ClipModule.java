package section.clip.impl.rules;
...
// Generated by: DC43RuleCodeGenerator2023-01-12T04:21:20.024+0100
@SuppressWarnings("all")
public final class ClipModule implements IRuleProvider<Module> {
	public static final ClipModule INSTANCE = init();
	private static boolean isInited = false;
	private Module module;
	private ClipModule() {};
	public static ClipModule init() {
		if(isInited) {
			return INSTANCE;
		}
		ClipModule self = new ClipModule();
		self.initContents();
		isInited = true;
		return self;
	}
