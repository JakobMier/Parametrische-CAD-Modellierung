package section.stringer.impl.rules;
...
// Generated by: DC43RuleCodeGenerator2023-02-28T23:18:49.553+0100
@SuppressWarnings("all")
public final class StringerModule implements IRuleProvider<Module> {
	public static final StringerModule INSTANCE = init();
	private static boolean isInited = false;
	private Module module;
	private StringerModule() {};
	public static StringerModule init() {
		if(isInited) {
			return INSTANCE;
		}
		StringerModule self = new StringerModule();
		self.initContents();
		isInited = true;
		return self;
	}
