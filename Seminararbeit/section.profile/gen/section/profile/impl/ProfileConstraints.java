...
import section.profile.impl.ProfilePackageImpl;
import section.profile.*;

/**
* The implementation of the model <b>Validator</b>.
* 2023-01-04T04:08:24.400+0100
*/
@SuppressWarnings("all")
public class ProfileConstraints extends DC43Constraints {
	/**
	* The singleton instance of the constraint holder.
	*/
	public static final ProfileConstraints INSTANCE = new ProfileConstraints();
	...
	protected EPackage getEPackage() {
		 return ProfilePackageImpl.eINSTANCE;
	}
