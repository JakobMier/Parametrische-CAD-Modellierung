package section.skin.impl.rules;
...
// Generated by: DC43RuleCodeGenerator2023-01-10T04:25:56.236+0100
@SuppressWarnings("all")
public final class SkinModule implements IRuleProvider<Module> {
	public static final SkinModule INSTANCE = init();
	private static boolean isInited = false;
	private Module module;
	private SkinModule() {};
	public static SkinModule init() {
		if(isInited) {
			return INSTANCE;
		}
		SkinModule self = new SkinModule();
		self.initContents();
		isInited = true;
		return self;
	}
