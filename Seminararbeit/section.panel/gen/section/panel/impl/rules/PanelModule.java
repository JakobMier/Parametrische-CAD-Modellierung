package section.panel.impl.rules;
...
// Generated by: DC43RuleCodeGenerator2023-01-04T04:09:18.706+0100
@SuppressWarnings("all")
public final class PanelModule implements IRuleProvider<Module> {
	public static final PanelModule INSTANCE = init();
	private static boolean isInited = false;
	private Module module;
	private PanelModule() {};
	public static PanelModule init() {
		if(isInited) {
			return INSTANCE;
		}
		PanelModule self = new PanelModule();
		self.initContents();
		isInited = true;
		return self;
	}
