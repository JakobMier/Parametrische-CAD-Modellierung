...
import section.panel.impl.PanelPackageImpl;
import section.panel.*;

/**
* The implementation of the model <b>Validator</b>.
* 2023-01-04T04:09:18.675+0100
*/
@SuppressWarnings("all")
public class PanelConstraints extends DC43Constraints {
	/**
	* The singleton instance of the constraint holder.
	*/
	public static final PanelConstraints INSTANCE = new PanelConstraints();

	public static final String DIAGNOSTIC_SOURCE = "Panel";

	public PanelConstraints() {
		super();
	}
	@Override
	protected EPackage getEPackage() {
		 return PanelPackageImpl.eINSTANCE;
	}
