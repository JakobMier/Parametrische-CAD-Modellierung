package section.rivet.impl.rules;
...
// Generated by: DC43RuleCodeGenerator2023-02-02T20:04:05.689+0100
@SuppressWarnings("all")
public final class RivetModule implements IRuleProvider<Module> {
	public static final RivetModule INSTANCE = init();
	private static boolean isInited = false;
	private Module module;
	private RivetModule() {};
	public static RivetModule init() {
		if(isInited) {
			return INSTANCE;
		}
		RivetModule self = new RivetModule();
		self.initContents();
		isInited = true;
		return self;
	}
