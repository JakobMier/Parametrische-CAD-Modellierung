...
* 2023-01-12T04:00:13.391+0100
*/
@SuppressWarnings("all")
public class SpantConstraints extends DC43Constraints {
	/**
	* The singleton instance of the constraint holder.
	*/
	public static final SpantConstraints INSTANCE = new SpantConstraints();

	public static final String DIAGNOSTIC_SOURCE = "Spant";

	public SpantConstraints() {
		super();
	}
	@Override
	protected EPackage getEPackage() {
		 return SpantPackageImpl.eINSTANCE;
	}
