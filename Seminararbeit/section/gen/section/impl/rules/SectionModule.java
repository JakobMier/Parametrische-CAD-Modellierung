...
// Generated by: DC43RuleCodeGenerator2023-01-10T01:44:20.921+0100
@SuppressWarnings("all")
public final class SectionModule implements IRuleProvider<Module> {
	public static final SectionModule INSTANCE = init();
	private static boolean isInited = false;
	private Module module;
	private SectionModule() {};
	public static SectionModule init() {
		if(isInited) {
			return INSTANCE;
		}
		SectionModule self = new SectionModule();
		self.initContents();
		isInited = true;
		return self;
	}
