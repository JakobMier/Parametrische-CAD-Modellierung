package section.profile.impl.rules;
...
// Generated by: DC43RuleCodeGenerator2023-01-04T04:08:24.456+0100
@SuppressWarnings("all")
public final class ProfileModule implements IRuleProvider<Module> {
	public static final ProfileModule INSTANCE = init();
	private static boolean isInited = false;
	private Module module;
	private ProfileModule() {};
	public static ProfileModule init() {
		if(isInited) {
			return INSTANCE;
		}
		ProfileModule self = new ProfileModule();
		self.initContents();
		isInited = true;
		return self;
	}
